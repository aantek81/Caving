...
public class CaveEvent {
    ...
    public CaveEvent(Plugin plugin, HashMap<String, Short> points, Messages messages) {
        this.plugin = plugin;
    ...
    public void start() {
        ...
        eventBar = BossBar.bossBar(messages.getMessageNoPrefix(MessageType.EVENT_NAME), //BossBar.bossBar(Component.text(String.valueOf(messages.getMessage(MessageType.EVENT_NAME))).color(NamedTextColor.DARK_GRAY),
                1,
                BossBar.Color.BLUE,
                BossBar.Overlay.PROGRESS);

        for (Player player : playersPoints.keySet()) {
            player.sendMessage(messages.getMessage(MessageType.EVENT_STARTED));
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                if (timeLeft <= 0) {
                    ...
                    for (Player player : playersPoints.keySet()) {
                        player.hideBossBar(eventBar);
                        player.sendMessage(messages.getMessage(MessageType.EVENT_PLAYER,
                                Placeholder.unparsed("points", String.valueOf(playersPoints.get(player))),
                                Placeholder.unparsed("coal", String.valueOf(playersCoal.get(player))),
                                Placeholder.unparsed("iron", String.valueOf(playersIron.get(player))),
                                Placeholder.unparsed("copper", String.valueOf(playersCopper.get(player))),
                                Placeholder.unparsed("gold", String.valueOf(playersGold.get(player))),
                                Placeholder.unparsed("redstone", String.valueOf(playersRedstone.get(player))),
                                Placeholder.unparsed("lapis", String.valueOf(playersLapis.get(player))),
                                Placeholder.unparsed("diamond", String.valueOf(playersDiamond.get(player))),
                                Placeholder.unparsed("emerald", String.valueOf(playersEmerald.get(player) ))));
                        player.sendMessage(messages.getMessage(MessageType.EVENT_PLAYER_WINNER, Placeholder.unparsed("player", winner.getName()), Placeholder.unparsed("points", String.valueOf(playersPoints.get(winner)))));
                    }
                    ...
                    eventCreator.sendMessage(messages.getMessage(MessageType.EVENT_TOTAL_ORES,
                            Placeholder.unparsed("coal", String.valueOf(sumCoal)),
                            Placeholder.unparsed("iron", String.valueOf(sumIron)),
                            Placeholder.unparsed("copper", String.valueOf(sumCopper)),
                            Placeholder.unparsed("gold", String.valueOf(sumGold)),
                            Placeholder.unparsed("redstone", String.valueOf(sumRedstone)),
                            Placeholder.unparsed("lapis", String.valueOf(sumLapis)),
                            Placeholder.unparsed("diamond", String.valueOf(sumDiamond)),
                            Placeholder.unparsed("emerald", String.valueOf(sumEmerald))));
    ...
    public void addCoal(Player player) {
        ...
        player.sendMessage(messages.getMessage(MessageType.PLAYER_MINED_COAL));
    }
    ...
    public void addIron(Player player) {
        ...
        player.sendMessage(messages.getMessage(MessageType.PLAYER_MINED_IRON));
    }
    ...
    public void addCopper(Player player) {
        ...
        player.sendMessage(messages.getMessage(MessageType.PLAYER_MINED_COPPER));
    }
    ...
    public void addGold(Player player) {
        ...
        player.sendMessage(messages.getMessage(MessageType.PLAYER_MINED_GOLD));
    }
    ...
    public void addRedstone(Player player) {
        ...
        player.sendMessage(messages.getMessage(MessageType.PLAYER_MINED_REDSTONE));
    }
    ...
    public void addLapis(Player player) {
        ...
        player.sendMessage(messages.getMessage(MessageType.PLAYER_MINED_LAPIS));
    }
    ...
    public void addDiamond(Player player) {
        ...
        player.sendMessage(messages.getMessage(MessageType.PLAYER_MINED_DIAMOND));
    }
    ...
    public void addEmerald(Player player) {
        ...
        player.sendMessage(messages.getMessage(MessageType.PLAYER_MINED_EMERALD));
    }
